            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              >
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
                  <span className="text-blue-600">HEALTHCARE</span> IMS
                </h1>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      >
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          SKYNET Pro Is Simple To Build With Simplicity In Mind. Ensuring Users Can Be Trained Quickly And Enjoy A Seamless Experience.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          SKYNET Pro Is Designed To Adapt And Be Tailored To Meet Your Specific Requirements.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          SKYNET Pro Automates Invoices, Streamlines Operations, And Reduces Manual Management.
        </p>
      </motion.div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
    <div className="flex flex-col md:flex-row gap-8">
      ...
      >
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          SKYNET Pro Keeps Your Business Running Online Even During Uninterrupted Events.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          Our System Is Designed To Protect All Your Business Data And Ensure Security For The Future.
        </p>
      </motion.div>
